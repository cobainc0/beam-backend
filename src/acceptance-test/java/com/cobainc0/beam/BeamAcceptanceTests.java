...
//public class BeamAcceptanceTests {
//    private static final String SAML_FORM = "saml-form";
//    private static final String SUBMIT_BUTTON = "submit";

//    @ClassRule
//    public static BeamAppRule beamAppRule = new BeamAppRule();

//    @Test
//    public void shouldHandleBeamAuthnRequest() throws Exception {
...
////        String proxyNodeUrlDefaultValue = "http://localhost:" + beamAppRule.getLocalPort();

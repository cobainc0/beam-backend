...
@Entity
@Table(name = "Vendor") //table name in SQL only req if the SQL table name
// differ from the class name i.e. Vendor class but vendors SQL, so poss remove since theyre the same...

@NamedQueries({
        @NamedQuery(name = "com.cobainc0.beam.core.Vendor.findAll",
                query = "select v from Vendor v"),
        @NamedQuery(name = "com.cobainc0.beam.core.Vendor.findByVendorName",
                query = "select v from Vendor v "
...
public class Vendor {
     ...
     */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) //to auto-generate pk
    private long vendorId;
    /**
     * vendor vendorName.
     */
    @Column(name = "vendorName") //not necessary if column and field name match equally
    private String vendorName;
    /**
     * vendor vendorAddress1.
     */
    @Column(name = "vendorAddress1")
    private String vendorAddress1;
    /**
     * vendor vendorAddress2.
     */
    @Column(name = "vendorAddress2")
    private String vendorAddress2;
    /**
     * vendor vendorAddress3.
     */
    @Column(name = "vendorAddress3")
    private String vendorAddress3;
    /**
     * vendor vendorPostcode.
     */
    @Column(name = "vendorPostcode")
    private String vendorPostcode;
    /**
     * vendor vendorTelephone.
     */
    @Column(name = "vendorTelephone")
     ...
     * vendor vendorLat.
     */
    @Column(name = "vendorLat")
    private String vendorLat;
    /**
     * vendor vendorLng.
     */
    @Column(name = "vendorLng")
     ...
     */
    public Vendor(String vendorAddress1,
